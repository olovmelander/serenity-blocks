...
|---|---|---|
| Fast-start: reveal after focus-chapter warm only; default ON (BIC §1) | `SHIPPED_AND_DEFAULT_ON` | `OdysseyBoardController.js:295-304`; default `'current'` in `odyssey-performance-flags.js:19-26` |
