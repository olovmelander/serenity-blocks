/**
 * Swedish Forest Water - Custom Water shader with reduced Fresnel for orange evening look
...
class SwedishForestWater extends Mesh {
		...
		const mirrorShader = {
			...
			fragmentShader: /* glsl */`
				...
				void main() {
					...
					float rf0 = 0.05;
					float reflectance = rf0 + ( 1.0 - rf0 ) * pow( ( 1.0 - theta ), 3.0 );  // Power 3 instead of 5 for softer falloff
