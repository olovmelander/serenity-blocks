...
const FAUNA_URLS = {
    ...
    'rare-mantaray-self.glb': new URL('./assets/fauna/rare-mantaray-self.glb', import.meta.url).href,
    'rare-whale-self.glb': new URL('./assets/fauna/rare-whale-self.glb', import.meta.url).href,
...
export const OCEAN_RARE_FAUNA_ASSETS = {
    ...
    whale: {
        primary: makeAssetRecord({
            id: 'rare-whale-self',
            kind: 'whale',
            fileName: 'rare-whale-self.glb',
            modelVersion: 'v1-self-generated',
            sourceMode: 'self-generated',
            license: 'MIT-project-local',
            author: 'Serenity Blocks TRELLIS + Blender pipeline',
            sourceUrl: 'artifacts/manta-whale/whale-source.png',
            triangleBudget: { min: 8000, max: 30000 },
    ...
    mantaRay: {
        primary: makeAssetRecord({
            id: 'rare-mantaray-self',
            kind: 'mantaRay',
            fileName: 'rare-mantaray-self.glb',
            modelVersion: 'v1-self-generated',
            sourceMode: 'self-generated',
            license: 'MIT-project-local',
            author: 'Serenity Blocks TRELLIS + Blender pipeline',
            sourceUrl: 'artifacts/manta-whale/manta-source.png',
            triangleBudget: { min: 8000, max: 30000 },
            maxBytes: 5 * 1024 * 1024,
            animationNames: ['Swim'],
            runtimeScale: 1,
