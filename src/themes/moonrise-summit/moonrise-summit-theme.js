...
const QUALITY_PRESETS = {
    Minimal: {
        starCount: 1000, mistLayers: 1, cloudCount: 2, waterSegs: [64, 32],
        bloomEnabled: false, bloomStrength: 0.3,
        enableAurora: false, enableGodRays: false,
        shootingPool: 4, vignette: 0.4, grain: 0.0, ca: 0.0,
        pixelRatioCap: 1.25, cameraBreathe: 0.0,
    },
    Low: {
        starCount: 1800, mistLayers: 2, cloudCount: 2, waterSegs: [96, 48],
        bloomEnabled: true, bloomStrength: 0.35,
        enableAurora: false, enableGodRays: false,
        shootingPool: 6, vignette: 0.42, grain: 0.012, ca: 0.0,
        pixelRatioCap: 1.5, cameraBreathe: 0.0,
    },
    Medium: {
        starCount: 2800, mistLayers: 2, cloudCount: 3, waterSegs: [128, 64],
        bloomEnabled: true, bloomStrength: 0.42,
        enableAurora: true, enableGodRays: false,
        shootingPool: 8, vignette: 0.43, grain: 0.018, ca: 0.0005,
        pixelRatioCap: 1.75, cameraBreathe: 0.18,
    },
    High: {
        starCount: 3500, mistLayers: 3, cloudCount: 3, waterSegs: [192, 96],
        bloomEnabled: true, bloomStrength: 0.5,
        enableAurora: true, enableGodRays: true,
        shootingPool: 10, vignette: 0.45, grain: 0.022, ca: 0.0008,
        pixelRatioCap: 2.0, cameraBreathe: 0.22,
    },
    Ultra: {
        starCount: 4500, mistLayers: 3, cloudCount: 4, waterSegs: [224, 112],
        bloomEnabled: true, bloomStrength: 0.6,
        enableAurora: true, enableGodRays: true,
        shootingPool: 14, vignette: 0.46, grain: 0.026, ca: 0.001,
        pixelRatioCap: 2.0, cameraBreathe: 0.26,
    },
    Extreme: {
        starCount: 5500, mistLayers: 4, cloudCount: 5, waterSegs: [256, 128],
        bloomEnabled: true, bloomStrength: 0.7,
        enableAurora: true, enableGodRays: true,
        shootingPool: 16, vignette: 0.48, grain: 0.03, ca: 0.0014,
        pixelRatioCap: 2.0, cameraBreathe: 0.3,
    },
};
...
export default class MoonriseSummitTheme extends BaseTheme {
    constructor() {
        ...
        this.materials = {
            ...
            aurora: [], cloud: [],
            mountain: [],
            moon: null, moonStreak: null, moonHalo: null,
            water: null,
            mist: [],
            godRay: null,
            shootingStar: null,
    ...
    _createMountains() {
        const layerConfigs = [
            {
                z: -100, scale: 1.0, fogAmount: 0.55, color: COLORS.mountainFar,
                snowLine: 0.62, rim: 0.85, layer: 0, w: 320, h: 90, y: 4,
            },
            {
                z: -68, scale: 1.0, fogAmount: 0.38, color: COLORS.mountainMid,
                snowLine: 0.55, rim: 1.0, layer: 1, w: 250, h: 80, y: 1,
            },
            {
                z: -45, scale: 1.0, fogAmount: 0.22, color: COLORS.mountainNear,
                snowLine: 0.55, rim: 0.95, layer: 2, w: 200, h: 65, y: -1,
            },
            {
                z: -25, scale: 1.0, fogAmount: 0.12, color: COLORS.mountainShoulder,
                snowLine: 0.7, rim: 0.6, layer: 3, w: 150, h: 50, y: -3,
            },
        ];
    ...
    cleanup() {
        ...
        this.godRayMesh = null;
        this.materials = {
            sky: null, stars: null, aurora: [], cloud: [],
            mountain: [], moon: null, moonStreak: null, moonHalo: null,
            water: null, mist: [], godRay: null, shootingStar: null,
        };
        super.cleanup();
    }
