...
import { draw, updateStats, drawNextPieces, triggerLineClearFlash, createPieceLockRipple, triggerBackgroundPulse } from './rendering/draw.js';
...
class SerenityBlocks {
    ...
    getPhysicsCallbacks() {
        return {
            ...
            onPieceLock: (piece) => createPieceLockRipple(piece),
    ...
    exposeGlobalControls() {
        ...
        window.move = (dir) => {
            coreMove(this.gameState, dir, () => this.soundManager.sfxPlayer.playMove());
        };

        window.rotate = (dir) => {
            coreRotate(this.gameState, dir, () => this.soundManager.sfxPlayer.playRotate());
        };
