/**
 * Serenity Blocks — Electron Preload Script
 *
 * Context-isolated bridge between renderer and main process.
 * Exposes three API surfaces: steamworks, electronDisplay, electronAPI.
 *
 * No console-method hijacking — use DevTools for debugging.
 */
